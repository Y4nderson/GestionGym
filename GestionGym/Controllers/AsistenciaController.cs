...
namespace GestionGym.Controllers
{
    ...
    public class AsistenciaController : ControllerBase
    {
        ...
        [HttpGet("ObtenerAsistenciaPorCliente")]
        public async Task<IActionResult> ObtenerAsistenciasPorcLIENTE(string nombre)
        {
            var respuesta = await _asistenciaRepositorio.EjecutarSpAsistencia(92, 0, 0, DateTime.Now, nombre);
            ...
            {
                return NotFound("No se encontraron  el cliente especificado.");
            }
        }
