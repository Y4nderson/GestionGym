...
builder.Services.AddScoped<TipoMembresiaRepositorio, TipoMembresiaRepositorio>();
builder.Services.AddScoped<ClienteRepositorio, ClienteRepositorio>();
builder.Services.AddScoped<MembresiaRepositorio, MembresiaRepositorio>();
builder.Services.AddScoped<PagoRepositorio, PagoRepositorio>();
builder.Services.AddScoped<EmpleadoRepositorio, EmpleadoRepositorio>();
builder.Services.AddScoped<BuscarClienteRepositorio, BuscarClienteRepositorio>();
builder.Services.AddScoped<RegistrarAsistenciaRepositorio, RegistrarAsistenciaRepositorio>();
...
{
    // Indica si se debe validar el
    // origen HTTPS del token.
